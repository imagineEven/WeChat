...
<script>
	...
	export default {
		...
		onShow(options) {
				...
				Storage.setStorageSync('OpenId', data.openid);
		...
		methods: {
			...
			initPosition() {
				...
				// 话框消失
				scaleTransition.scale(0.1).opacity(0).step();
				...
				lookResultAnimation.scale(0.01).opacity(0).step();
			...
			createBoxAnimation() {
				...
				boxAnimation.scale(1, 1).opacity(1).step();
			...
			createBtnAnimation() {
				...
				btnAnimation.scale(1, 1).opacity(1).step();
				...
				lookResultAnimation.scale(1, 1).opacity(1).step();
				this.lookResultAnimationData = lookResultAnimation.export();
				return this.awaitByPormise(250);
			},
			...
			getOut() {
				...
				this.shakeBtnAnimation().then(() => {
					...
					outTransition.scale(0.1, 0.1).opacity(0).step();
